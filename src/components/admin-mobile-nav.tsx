...
import {
  Ban, CalendarDays, Cake, ClipboardList, CreditCard, DatabaseBackup, Images, Menu, Package, Scissors, Settings, Star, Tag, Upload, Users,
  X, LogOut, type LucideIcon
} from "lucide-react";

const iconMap: Record<string, LucideIcon> = {
  CalendarDays, Users, Cake, Scissors, Package,
  CreditCard, Settings, Ban, Upload, ClipboardList, Star, Images, DatabaseBackup, Tag
};
